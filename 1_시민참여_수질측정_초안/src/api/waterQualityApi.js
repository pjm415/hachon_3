...
// 괴정천 (지오빌1차 아파트 앞 지점): 부산 사하구 하단동 지오빌1차 아파트 바로 앞 괴정천 물길 정밀 좌표 (35.1068, 128.9655)
export const BUSAN_RIVER_STATIONS = [
  ...
  { id: '2014A85', name: '괴정천 (지오빌1차 아파트 앞 지점)', river: '괴정천', defaultBod: 4.2, defaultDo: 6.5, defaultPh: 6.6, defaultTds: 285, temp: 19.5, lat: 35.1068, lng: 128.9655 }
];
