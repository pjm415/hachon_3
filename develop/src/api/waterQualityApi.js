...
// 괴정천 (강변대로/하단도서관 지점): 부산 사하구 하단도서관 및 강변대로 옆 괴정천 넓은 파란색 하천 물길 정밀 좌표 (35.1054, 128.9602)
export const BUSAN_RIVER_STATIONS = [
  ...
  { id: '2014A85', name: '괴정천 (강변대로·하단도서관 지점)', river: '괴정천', defaultBod: 4.2, defaultDo: 6.5, defaultPh: 6.6, defaultTds: 285, temp: 19.5, lat: 35.1054, lng: 128.9602 }
];
