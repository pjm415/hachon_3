...
// 괴정천 (하굿둑 지점): 부산 사하구 하단동 괴정천 수문/하구 정밀 좌표 (35.1042, 128.9658)
export const BUSAN_RIVER_STATIONS = [
  ...
  { id: '2014A85', name: '괴정천 (하굿둑 지점)', river: '괴정천', defaultBod: 4.2, defaultDo: 6.5, defaultPh: 6.6, defaultTds: 285, temp: 19.5, lat: 35.1042, lng: 128.9658 }
];
